package org.scray.examples.ingest.nrw.cli
...
object Options extends LazyLogging {
   ...
   */
  val parser = new OptionParser[Config]("nrw-traffic-data-client") {
    head("Parameters for nrw-traffic-data-client", "1.0-SNAPSHOT")
