...
peer chaincode invoke -o orderer.example.com:7050 --tls --cafile /tmp/tlsca.example.com-cert.pem -C $CHANNEL_ID -n basic -c '{"function":"CreateAsset","Args":["'${ASSET_ID}'", "read", "3", "1"]}'
