...
peer chaincode invoke -o orderer.example.com:30081 --tls --cafile /tmp/tlsca.example.com-cert.pem -C $CHANNEL_ID -n basic -c '{"function":"TransferAsset","Args":["'${ASSET_ID}'", "'${NEW_OWNER}'"]}'
